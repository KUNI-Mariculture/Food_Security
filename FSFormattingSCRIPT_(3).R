...
EnergyAdequacy <- read.csv(file="~/KUNI/Food_Security/EnergyAdequacy.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodDeficit <- read.csv(file="~/KUNI/Food_Security/FoodDeficit.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodPrice <- read.csv(file="~/KUNI/Food_Security/FoodPrice.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodProduction <- read.csv(file="~/KUNI/Food_Security/FoodProduction.csv", header=FALSE, stringsAsFactors=FALSE)
...
GDP <- read.csv(file="~/KUNI/Food_Security/GDP.csv", header=FALSE, stringsAsFactors=FALSE)
...
Protein <- read.csv(file="~/KUNI/Food_Security/Protein.csv", header=FALSE, stringsAsFactors=FALSE)
...
ProteinAnimal <- read.csv(file="~/KUNI/Food_Security/ProteinAnimal.csv", header=FALSE, stringsAsFactors=FALSE)
...
Undernourish <- read.csv(file="~/KUNI/Food_Security/Undernourish.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodPriceVolatility <- read.csv(file="~/KUNI/Food_Security/FoodPriceVolatility.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodProductionVariability <- read.csv(file="~/KUNI/Food_Security/FoodProductionVariability.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodSupplyVariability <- read.csv(file="~/KUNI/Food_Security/FoodSupplyVariability.csv", header=FALSE, stringsAsFactors=FALSE)
...
TotalPopulation <- read.csv(file="~/KUNI/Food_Security/TotalPopulation.csv", header=FALSE, stringsAsFactors=FALSE)
...
NumberUndernourished <- read.csv(file="~/KUNI/Food_Security/NumberUndernourished.csv", header=FALSE, stringsAsFactors=FALSE)
...
DietaryEnergySupply <- read.csv(file="~/KUNI/Food_Security/DietaryEnergySupply.csv", header=FALSE, stringsAsFactors=FALSE)
...
FatSupply <- read.csv(file="~/KUNI/Food_Security/FatSupply.csv", header=FALSE, stringsAsFactors=FALSE)
...
FoodOverAcquisition <- read.csv(file="~/KUNI/Food_Security/FoodOverAcquisition.csv", header=FALSE, stringsAsFactors=FALSE)
